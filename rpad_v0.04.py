...
main_application.wm_iconbitmap(r'icons\icon.ico')
...
text_editor.configure(font = ("Comic Sans MS", 12))

#==================================================================================== Text Editor End =======================================================================================

#==================================================================================== Main Status Bar =========================================================================================

status_bar = tk.Label(main_application, text = "Status Bar", font = ('Comic Sans MS', 12, "bold"))
...
## String append functionality
def append_date(event = None):
    now = datetime.now()
    dt_str = now.strftime(" %d/%m/%Y ")
    text_editor.insert(tk.INSERT, dt_str)

def append_time(event = None):
    now = datetime.now()
    time_str = now.strftime(" %H:%M %p ")
    text_editor.insert(tk.INSERT, time_str)

def append_wkday(event = None):
    now = datetime.now()
    wkday_str = now.strftime(" %A ")
    text_editor.insert(tk.INSERT, wkday_str)
...
main_application.bind("<F5>", append_date)
main_application.bind("<F6>", append_time)
main_application.bind("<F7>", append_wkday)
